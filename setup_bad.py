...
setup(
    ...
    version=str('1.1.0'),  # Required ## CHANGE IT ALSO IN __init____ and readme !!!!

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description=' autorino is a tool for Assisted Unloading, Treatment & Organisation of RINex Observations',  # Optional
    ...
    long_description="""
autorino is a tool for Assisted Unloading, Treatment & Organisation of RINex Observations
""",  # Optional
    ...
    url='https://github.com/IPGP/autorino',  # Optional
    ...
    # larger catalog.
    keywords='geodesy, gnss, rinex, acquisition, download, conversion, handeling',  # Optional
